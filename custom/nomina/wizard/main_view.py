...
class NominaMainView(models.TransientModel):
    ...
    def action_refrescar_derecho_vacacional(self) -> None:
        ...
        for empleado in empleados:
            ...
            # Query: "Plan Vacacional"
            domain = [("id", "=", empleado.plan_vacacional_id.id)]
            plan = self.env["nomina.plan.vacacional"].search(domain)
            ...
            minimo = sorted(
                ...
                reverse=False,
            )[0].rango_id.limite_inferior

            # En caso derechos activos (todos). (Itera todos exacto).
            antiguedad_compuesto = empleado.antiguedad_anhos - minimo
